 ...
 */
public class StreamSound extends Audio {
	...
	/**
	 * @see warlord.sound.AudioImpl#isPlaying()
	 */
	...
	/**
	 * @see warlord.sound.AudioImpl#playAsMusic(float, float, boolean)
	 */
	...
	/**
	 * @see warlord.sound.AudioImpl#playAsSoundEffect(float, float, boolean, float, float, float)
	 */
	...
	/**
	 * @see warlord.sound.AudioImpl#playAsSoundEffect(float, float, boolean)
	 */
	...
	/**
	 * @see warlord.sound.AudioImpl#stop()
	 */
	public void stop() {
	...
	/**
	 * @see warlord.sound.AudioImpl#setPosition(float)
	 */
	...
	/**
	 * @see warlord.sound.AudioImpl#getPosition()
	 */
